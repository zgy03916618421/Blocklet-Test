...
const formSchema = z.object({
  ...
  mobile: z
    ...
    .regex(new RegExp(/^1[0-9]{10}$/), { message: 'This is not a valid mobile number' }),
});
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
              ...
              <FormItem>
                ...
                <FormControl>
                  <Input
                    ...
                    placeholder="This is your mobile number."
                    {...field}
                    disabled={!edit}
                  />
                </FormControl>
          ...
          {edit ? (
            <div className="flex justify-around">
              <Button type="button" onClick={onCancle} disabled={laoding}>
                Cancle
              </Button>
